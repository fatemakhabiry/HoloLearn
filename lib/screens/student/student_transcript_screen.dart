      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: AppStyles.spacingM),
            Text('Could not load transcript', style: AppStyles.h3.copyWith(color: context.textPrimary)),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: AppStyles.spacingM),
            Text('No transcript yet', style: AppStyles.h3.copyWith(color: context.textPrimary)),
            const SizedBox(height: AppStyles.spacingS),
            Text(
