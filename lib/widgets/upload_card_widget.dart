...
//     final cardMaxWidth = (screenWidth / 2) - 60;
//     return Container(
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        // Icon circle/box scales with available card width, clamped to sane bounds
        final iconBoxSize = cardWidth.clamp(80.0, 200.0);
